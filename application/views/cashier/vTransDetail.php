...
<div class="container">
    ...
    <div class="row">
        ...
        <form action="<?php echo site_url().'/cashier/discount'; ?>" class="form-horizontal" method="post">
            ...
            <table class="table">
                ...
                <tr>
                    <td>Total Belanja</td>
                    <td><?php echo "Rp".number_format($info['tran_amount']); ?> <button type="submit" class="btn btn-primary">Diskon</button></td>
                </tr>
                <tr>
                    <td>Pembayaran</td>
            ...
            <?php foreach($trans as $tran): ?>
                <tr>
                    ...
                    <td><?php echo "Rp".number_format($tran['item_price']); ?></td>
                </tr>
            <?php endforeach; ?>
            </table>
